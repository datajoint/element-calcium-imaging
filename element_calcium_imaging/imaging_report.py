...
def activate(
    ...
    activate(schema_name, *, create_schema=True, create_tables=True)
        ...
        :param imaging_schema_name: schema name of the activated imaging element for
        ...
        :param create_tables: when True (default), create tables in the database if they
            do not yet exist.
    (The "activation" of this imaging_report module should be evoked by one of the
        imaging modules only)
    """
    global imaging
